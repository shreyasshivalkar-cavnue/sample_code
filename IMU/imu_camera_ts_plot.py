...
if __name__ == "__main__":
    ...
    parser.add_argument("--plot_filtered", nargs='?', const=1, type=int, help="Plot filtered imu readings.")
    ...
    imu_filtered_reading_plot_name = "imu_plot_filtered_" + datetime.datetime.now().strftime("%Y%m%d-%H%M%S.%f") + ".png"
    ...
    if args.plot_filtered:
        ...
        plot_imu_readings(imu_filtered_reading_df, "fid", imu_filtered_reading_plot_name)
