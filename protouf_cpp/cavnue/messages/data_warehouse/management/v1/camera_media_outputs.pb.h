...
#ifndef GOOGLE_PROTOBUF_INCLUDED_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv1_2fcamera_5fmedia_5foutputs_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv1_2fcamera_5fmedia_5foutputs_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv1_2fcamera_5fmedia_5foutputs_2eproto
...
struct TableStruct_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv1_2fcamera_5fmedia_5foutputs_2eproto {
  static const ::uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable
    descriptor_table_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv1_2fcamera_5fmedia_5foutputs_2eproto;
namespace cavnue {
namespace messages {
...
PROTOBUF_NAMESPACE_OPEN
template <>
::cavnue::messages::data_warehouse::management::v1::CameraMediaOutput* Arena::CreateMaybeMessage<::cavnue::messages::data_warehouse::management::v1::CameraMediaOutput>(Arena*);
template <>
::cavnue::messages::data_warehouse::management::v1::CameraMediaOutputMetadata* Arena::CreateMaybeMessage<::cavnue::messages::data_warehouse::management::v1::CameraMediaOutputMetadata>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class CameraMediaOutput final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:cavnue.messages.data_warehouse.management.v1.CameraMediaOutput) */ {
 public:
  ...
  static ::absl::string_view FullMessageName() {
    return "cavnue.messages.data_warehouse.management.v1.CameraMediaOutput";
  }
  protected:
  ...
  public:
  // @@protoc_insertion_point(class_scope:cavnue.messages.data_warehouse.management.v1.CameraMediaOutput)
 private:
  class _Internal;
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv1_2fcamera_5fmedia_5foutputs_2eproto;
};// -------------------------------------------------------------------

class CameraMediaOutputMetadata final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:cavnue.messages.data_warehouse.management.v1.CameraMediaOutputMetadata) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() {
    return "cavnue.messages.data_warehouse.management.v1.CameraMediaOutputMetadata";
  }
  protected:
  ...
  public:
  // @@protoc_insertion_point(class_scope:cavnue.messages.data_warehouse.management.v1.CameraMediaOutputMetadata)
 private:
  class _Internal;
...
inline const std::string& CameraMediaOutput::uri() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v1.CameraMediaOutput.uri)
...
inline PROTOBUF_ALWAYS_INLINE void CameraMediaOutput::set_uri(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v1.CameraMediaOutput.uri)
}
inline std::string* CameraMediaOutput::mutable_uri() {
  std::string* _s = _internal_mutable_uri();
  // @@protoc_insertion_point(field_mutable:cavnue.messages.data_warehouse.management.v1.CameraMediaOutput.uri)
  return _s;
}
...
inline std::string* CameraMediaOutput::release_uri() {
  // @@protoc_insertion_point(field_release:cavnue.messages.data_warehouse.management.v1.CameraMediaOutput.uri)
...
inline void CameraMediaOutput::set_allocated_uri(std::string* value) {
  ...
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:cavnue.messages.data_warehouse.management.v1.CameraMediaOutput.uri)
}
...
inline ::int64_t CameraMediaOutput::data_id() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v1.CameraMediaOutput.data_id)
  return _internal_data_id();
}
inline void CameraMediaOutput::set_data_id(::int64_t value) {
  _internal_set_data_id(value);
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v1.CameraMediaOutput.data_id)
}
...
inline const ::PROTOBUF_NAMESPACE_ID::Timestamp& CameraMediaOutput::ts() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v1.CameraMediaOutput.ts)
  return _internal_ts();
}
inline void CameraMediaOutput::unsafe_arena_set_allocated_ts(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:cavnue.messages.data_warehouse.management.v1.CameraMediaOutput.ts)
}
...
inline ::PROTOBUF_NAMESPACE_ID::Timestamp* CameraMediaOutput::unsafe_arena_release_ts() {
  // @@protoc_insertion_point(field_release:cavnue.messages.data_warehouse.management.v1.CameraMediaOutput.ts)
  _impl_._has_bits_[0] &= ~0x00000002u;
  ::PROTOBUF_NAMESPACE_ID::Timestamp* temp = _impl_.ts_;
  _impl_.ts_ = nullptr;
  return temp;
...
inline ::PROTOBUF_NAMESPACE_ID::Timestamp* CameraMediaOutput::mutable_ts() {
  ...
  // @@protoc_insertion_point(field_mutable:cavnue.messages.data_warehouse.management.v1.CameraMediaOutput.ts)
  return _msg;
}
inline void CameraMediaOutput::set_allocated_ts(::PROTOBUF_NAMESPACE_ID::Timestamp* ts) {
  ...
  _impl_.ts_ = ts;
  // @@protoc_insertion_point(field_set_allocated:cavnue.messages.data_warehouse.management.v1.CameraMediaOutput.ts)
}
...
inline const std::string& CameraMediaOutputMetadata::uri() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v1.CameraMediaOutputMetadata.uri)
  return _internal_uri();
}
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void CameraMediaOutputMetadata::set_uri(Arg_&& arg,
  ...
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.uri_.Set(static_cast<Arg_&&>(arg), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v1.CameraMediaOutputMetadata.uri)
}
inline std::string* CameraMediaOutputMetadata::mutable_uri() {
  std::string* _s = _internal_mutable_uri();
  // @@protoc_insertion_point(field_mutable:cavnue.messages.data_warehouse.management.v1.CameraMediaOutputMetadata.uri)
  return _s;
}
...
inline std::string* CameraMediaOutputMetadata::release_uri() {
  // @@protoc_insertion_point(field_release:cavnue.messages.data_warehouse.management.v1.CameraMediaOutputMetadata.uri)
  if ((_impl_._has_bits_[0] & 0x00000001u) == 0) {
    return nullptr;
  }
  _impl_._has_bits_[0] &= ~0x00000001u;
...
inline void CameraMediaOutputMetadata::set_allocated_uri(std::string* value) {
  ...
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:cavnue.messages.data_warehouse.management.v1.CameraMediaOutputMetadata.uri)
}
...
inline const ::PROTOBUF_NAMESPACE_ID::Timestamp& CameraMediaOutputMetadata::start_ts() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v1.CameraMediaOutputMetadata.start_ts)
...
inline void CameraMediaOutputMetadata::unsafe_arena_set_allocated_start_ts(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:cavnue.messages.data_warehouse.management.v1.CameraMediaOutputMetadata.start_ts)
}
...
inline ::PROTOBUF_NAMESPACE_ID::Timestamp* CameraMediaOutputMetadata::unsafe_arena_release_start_ts() {
  // @@protoc_insertion_point(field_release:cavnue.messages.data_warehouse.management.v1.CameraMediaOutputMetadata.start_ts)
  _impl_._has_bits_[0] &= ~0x00000002u;
  ::PROTOBUF_NAMESPACE_ID::Timestamp* temp = _impl_.start_ts_;
  _impl_.start_ts_ = nullptr;
  return temp;
...
inline ::PROTOBUF_NAMESPACE_ID::Timestamp* CameraMediaOutputMetadata::mutable_start_ts() {
  ...
  // @@protoc_insertion_point(field_mutable:cavnue.messages.data_warehouse.management.v1.CameraMediaOutputMetadata.start_ts)
  return _msg;
}
inline void CameraMediaOutputMetadata::set_allocated_start_ts(::PROTOBUF_NAMESPACE_ID::Timestamp* start_ts) {
  ...
  _impl_.start_ts_ = start_ts;
  // @@protoc_insertion_point(field_set_allocated:cavnue.messages.data_warehouse.management.v1.CameraMediaOutputMetadata.start_ts)
}
...
inline ::uint32_t CameraMediaOutputMetadata::height() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v1.CameraMediaOutputMetadata.height)
  return _internal_height();
}
inline void CameraMediaOutputMetadata::set_height(::uint32_t value) {
  _internal_set_height(value);
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v1.CameraMediaOutputMetadata.height)
}
...
inline ::uint32_t CameraMediaOutputMetadata::width() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v1.CameraMediaOutputMetadata.width)
  return _internal_width();
}
inline void CameraMediaOutputMetadata::set_width(::uint32_t value) {
  _internal_set_width(value);
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v1.CameraMediaOutputMetadata.width)
}
...
inline float CameraMediaOutputMetadata::duration() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v1.CameraMediaOutputMetadata.duration)
  return _internal_duration();
}
inline void CameraMediaOutputMetadata::set_duration(float value) {
  _internal_set_duration(value);
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v1.CameraMediaOutputMetadata.duration)
}
...
inline ::uint32_t CameraMediaOutputMetadata::frame_rate() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v1.CameraMediaOutputMetadata.frame_rate)
...
inline void CameraMediaOutputMetadata::set_frame_rate(::uint32_t value) {
  ...
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v1.CameraMediaOutputMetadata.frame_rate)
}
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv1_2fcamera_5fmedia_5foutputs_2eproto_2epb_2eh
