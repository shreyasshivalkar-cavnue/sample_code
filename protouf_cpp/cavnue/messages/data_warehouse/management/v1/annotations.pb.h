...
#ifndef GOOGLE_PROTOBUF_INCLUDED_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv1_2fannotations_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv1_2fannotations_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv1_2fannotations_2eproto
...
struct TableStruct_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv1_2fannotations_2eproto {
  static const ::uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable
    descriptor_table_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv1_2fannotations_2eproto;
namespace cavnue {
namespace messages {
...
PROTOBUF_NAMESPACE_OPEN
template <>
::cavnue::messages::data_warehouse::management::v1::FrameAnnotationAttributes* Arena::CreateMaybeMessage<::cavnue::messages::data_warehouse::management::v1::FrameAnnotationAttributes>(Arena*);
template <>
::cavnue::messages::data_warehouse::management::v1::FrameAnnotationBox2* Arena::CreateMaybeMessage<::cavnue::messages::data_warehouse::management::v1::FrameAnnotationBox2>(Arena*);
template <>
::cavnue::messages::data_warehouse::management::v1::FrameAnnotationBox3* Arena::CreateMaybeMessage<::cavnue::messages::data_warehouse::management::v1::FrameAnnotationBox3>(Arena*);
template <>
::cavnue::messages::data_warehouse::management::v1::FrameAnnotationSegmentation* Arena::CreateMaybeMessage<::cavnue::messages::data_warehouse::management::v1::FrameAnnotationSegmentation>(Arena*);
template <>
::cavnue::messages::data_warehouse::management::v1::FrameAnnotationSegmentation_MaskMap* Arena::CreateMaybeMessage<::cavnue::messages::data_warehouse::management::v1::FrameAnnotationSegmentation_MaskMap>(Arena*);
template <>
::cavnue::messages::data_warehouse::management::v1::Label* Arena::CreateMaybeMessage<::cavnue::messages::data_warehouse::management::v1::Label>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class FrameAnnotationBox2 final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:cavnue.messages.data_warehouse.management.v1.FrameAnnotationBox2) */ {
 public:
  ...
  static ::absl::string_view FullMessageName() {
    return "cavnue.messages.data_warehouse.management.v1.FrameAnnotationBox2";
  }
  protected:
  ...
  public:
  // @@protoc_insertion_point(class_scope:cavnue.messages.data_warehouse.management.v1.FrameAnnotationBox2)
 private:
  class _Internal;
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv1_2fannotations_2eproto;
};// -------------------------------------------------------------------

class FrameAnnotationBox3 final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:cavnue.messages.data_warehouse.management.v1.FrameAnnotationBox3) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() {
    return "cavnue.messages.data_warehouse.management.v1.FrameAnnotationBox3";
  }
  protected:
  ...
  public:
  // @@protoc_insertion_point(class_scope:cavnue.messages.data_warehouse.management.v1.FrameAnnotationBox3)
 private:
  class _Internal;
...
class FrameAnnotationSegmentation_MaskMap final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:cavnue.messages.data_warehouse.management.v1.FrameAnnotationSegmentation.MaskMap) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() {
    return "cavnue.messages.data_warehouse.management.v1.FrameAnnotationSegmentation.MaskMap";
  }
  protected:
  ...
  public:
  // @@protoc_insertion_point(class_scope:cavnue.messages.data_warehouse.management.v1.FrameAnnotationSegmentation.MaskMap)
 private:
  class _Internal;
...
class FrameAnnotationSegmentation final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:cavnue.messages.data_warehouse.management.v1.FrameAnnotationSegmentation) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() {
    return "cavnue.messages.data_warehouse.management.v1.FrameAnnotationSegmentation";
  }
  protected:
  ...
  public:
  void clear_mask_map() ;
  ::cavnue::messages::data_warehouse::management::v1::FrameAnnotationSegmentation_MaskMap* mutable_mask_map(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::cavnue::messages::data_warehouse::management::v1::FrameAnnotationSegmentation_MaskMap >*
      mutable_mask_map();
  private:
  const ::cavnue::messages::data_warehouse::management::v1::FrameAnnotationSegmentation_MaskMap& _internal_mask_map(int index) const;
  ::cavnue::messages::data_warehouse::management::v1::FrameAnnotationSegmentation_MaskMap* _internal_add_mask_map();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::cavnue::messages::data_warehouse::management::v1::FrameAnnotationSegmentation_MaskMap>& _internal_mask_map() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::cavnue::messages::data_warehouse::management::v1::FrameAnnotationSegmentation_MaskMap>* _internal_mutable_mask_map();
  public:
  const ::cavnue::messages::data_warehouse::management::v1::FrameAnnotationSegmentation_MaskMap& mask_map(int index) const;
  ::cavnue::messages::data_warehouse::management::v1::FrameAnnotationSegmentation_MaskMap* add_mask_map();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::cavnue::messages::data_warehouse::management::v1::FrameAnnotationSegmentation_MaskMap >&
      mask_map() const;
  // optional int64 data_id = 1 [json_name = "dataId", (.cavnue.messages.common.v1.primary_key) = true, (.gen_bq_schema.bigquery) = {
  bool has_data_id() const;
  void clear_data_id() ;
  ...
  public:
  // @@protoc_insertion_point(class_scope:cavnue.messages.data_warehouse.management.v1.FrameAnnotationSegmentation)
 private:
  class _Internal;
  ...
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::cavnue::messages::data_warehouse::management::v1::FrameAnnotationSegmentation_MaskMap > mask_map_;
    ::int64_t data_id_;
    ::int64_t batch_id_;
  };
  union { Impl_ _impl_; };
...
class FrameAnnotationAttributes final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:cavnue.messages.data_warehouse.management.v1.FrameAnnotationAttributes) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() {
    return "cavnue.messages.data_warehouse.management.v1.FrameAnnotationAttributes";
  }
  protected:
  ...
  public:
  // @@protoc_insertion_point(class_scope:cavnue.messages.data_warehouse.management.v1.FrameAnnotationAttributes)
 private:
  class _Internal;
...
class Label final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:cavnue.messages.data_warehouse.management.v1.Label) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() {
    return "cavnue.messages.data_warehouse.management.v1.Label";
  }
  protected:
  ...
  public:
  // @@protoc_insertion_point(class_scope:cavnue.messages.data_warehouse.management.v1.Label)
 private:
  class _Internal;
...
inline ::int64_t FrameAnnotationBox2::data_id() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v1.FrameAnnotationBox2.data_id)
  return _internal_data_id();
}
inline void FrameAnnotationBox2::set_data_id(::int64_t value) {
  _internal_set_data_id(value);
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v1.FrameAnnotationBox2.data_id)
}
...
inline ::int64_t FrameAnnotationBox2::batch_id() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v1.FrameAnnotationBox2.batch_id)
  return _internal_batch_id();
}
inline void FrameAnnotationBox2::set_batch_id(::int64_t value) {
  _internal_set_batch_id(value);
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v1.FrameAnnotationBox2.batch_id)
}
...
inline ::cavnue::messages::geometry::v1::BoundingBox2f* FrameAnnotationBox2::mutable_annotations(int index) {
  // @@protoc_insertion_point(field_mutable:cavnue.messages.data_warehouse.management.v1.FrameAnnotationBox2.annotations)
...
FrameAnnotationBox2::mutable_annotations() {
  // @@protoc_insertion_point(field_mutable_list:cavnue.messages.data_warehouse.management.v1.FrameAnnotationBox2.annotations)
...
inline const ::cavnue::messages::geometry::v1::BoundingBox2f& FrameAnnotationBox2::annotations(int index) const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v1.FrameAnnotationBox2.annotations)
...
inline ::cavnue::messages::geometry::v1::BoundingBox2f* FrameAnnotationBox2::add_annotations() {
  ...
  // @@protoc_insertion_point(field_add:cavnue.messages.data_warehouse.management.v1.FrameAnnotationBox2.annotations)
  return _add;
}
...
FrameAnnotationBox2::annotations() const {
  // @@protoc_insertion_point(field_list:cavnue.messages.data_warehouse.management.v1.FrameAnnotationBox2.annotations)
...
inline ::int64_t FrameAnnotationBox2::labels(int index) const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v1.FrameAnnotationBox2.labels)
  return _internal_labels(index);
}
inline void FrameAnnotationBox2::set_labels(int index, ::int64_t value) {
  _internal_mutable_labels()->Set(index, value);
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v1.FrameAnnotationBox2.labels)
}
inline void FrameAnnotationBox2::add_labels(::int64_t value) {
  _internal_add_labels(value);
  // @@protoc_insertion_point(field_add:cavnue.messages.data_warehouse.management.v1.FrameAnnotationBox2.labels)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField<::int64_t>& FrameAnnotationBox2::labels() const {
  // @@protoc_insertion_point(field_list:cavnue.messages.data_warehouse.management.v1.FrameAnnotationBox2.labels)
  return _internal_labels();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField<::int64_t>* FrameAnnotationBox2::mutable_labels() {
  // @@protoc_insertion_point(field_mutable_list:cavnue.messages.data_warehouse.management.v1.FrameAnnotationBox2.labels)
...
inline ::int64_t FrameAnnotationBox2::actors(int index) const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v1.FrameAnnotationBox2.actors)
...
inline void FrameAnnotationBox2::set_actors(int index, ::int64_t value) {
  ...
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v1.FrameAnnotationBox2.actors)
}
inline void FrameAnnotationBox2::add_actors(::int64_t value) {
  _internal_add_actors(value);
  // @@protoc_insertion_point(field_add:cavnue.messages.data_warehouse.management.v1.FrameAnnotationBox2.actors)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField<::int64_t>& FrameAnnotationBox2::actors() const {
  // @@protoc_insertion_point(field_list:cavnue.messages.data_warehouse.management.v1.FrameAnnotationBox2.actors)
  return _internal_actors();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField<::int64_t>* FrameAnnotationBox2::mutable_actors() {
  // @@protoc_insertion_point(field_mutable_list:cavnue.messages.data_warehouse.management.v1.FrameAnnotationBox2.actors)
...
inline ::int64_t FrameAnnotationBox3::data_id() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v1.FrameAnnotationBox3.data_id)
  return _internal_data_id();
}
inline void FrameAnnotationBox3::set_data_id(::int64_t value) {
  _internal_set_data_id(value);
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v1.FrameAnnotationBox3.data_id)
}
...
inline ::int64_t FrameAnnotationBox3::batch_id() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v1.FrameAnnotationBox3.batch_id)
  return _internal_batch_id();
}
inline void FrameAnnotationBox3::set_batch_id(::int64_t value) {
  _internal_set_batch_id(value);
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v1.FrameAnnotationBox3.batch_id)
}
...
inline ::cavnue::messages::geometry::v1::RotatedBoundingBox3d* FrameAnnotationBox3::mutable_annotations(int index) {
  // @@protoc_insertion_point(field_mutable:cavnue.messages.data_warehouse.management.v1.FrameAnnotationBox3.annotations)
  return _internal_mutable_annotations()->Mutable(index);
}
...
FrameAnnotationBox3::mutable_annotations() {
  // @@protoc_insertion_point(field_mutable_list:cavnue.messages.data_warehouse.management.v1.FrameAnnotationBox3.annotations)
  return _internal_mutable_annotations();
}
...
inline const ::cavnue::messages::geometry::v1::RotatedBoundingBox3d& FrameAnnotationBox3::annotations(int index) const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v1.FrameAnnotationBox3.annotations)
  return _internal_annotations(index);
}
...
inline ::cavnue::messages::geometry::v1::RotatedBoundingBox3d* FrameAnnotationBox3::add_annotations() {
  ...
  // @@protoc_insertion_point(field_add:cavnue.messages.data_warehouse.management.v1.FrameAnnotationBox3.annotations)
  return _add;
}
...
FrameAnnotationBox3::annotations() const {
  // @@protoc_insertion_point(field_list:cavnue.messages.data_warehouse.management.v1.FrameAnnotationBox3.annotations)
  return _internal_annotations();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::cavnue::messages::geometry::v1::RotatedBoundingBox3d>&
...
inline ::int64_t FrameAnnotationBox3::labels(int index) const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v1.FrameAnnotationBox3.labels)
  return _internal_labels(index);
}
inline void FrameAnnotationBox3::set_labels(int index, ::int64_t value) {
  _internal_mutable_labels()->Set(index, value);
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v1.FrameAnnotationBox3.labels)
}
inline void FrameAnnotationBox3::add_labels(::int64_t value) {
  _internal_add_labels(value);
  // @@protoc_insertion_point(field_add:cavnue.messages.data_warehouse.management.v1.FrameAnnotationBox3.labels)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField<::int64_t>& FrameAnnotationBox3::labels() const {
  // @@protoc_insertion_point(field_list:cavnue.messages.data_warehouse.management.v1.FrameAnnotationBox3.labels)
  return _internal_labels();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField<::int64_t>* FrameAnnotationBox3::mutable_labels() {
  // @@protoc_insertion_point(field_mutable_list:cavnue.messages.data_warehouse.management.v1.FrameAnnotationBox3.labels)
  return _internal_mutable_labels();
}
...
inline ::int64_t FrameAnnotationBox3::actors(int index) const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v1.FrameAnnotationBox3.actors)
  return _internal_actors(index);
}
inline void FrameAnnotationBox3::set_actors(int index, ::int64_t value) {
  _internal_mutable_actors()->Set(index, value);
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v1.FrameAnnotationBox3.actors)
}
inline void FrameAnnotationBox3::add_actors(::int64_t value) {
  _internal_add_actors(value);
  // @@protoc_insertion_point(field_add:cavnue.messages.data_warehouse.management.v1.FrameAnnotationBox3.actors)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField<::int64_t>& FrameAnnotationBox3::actors() const {
  // @@protoc_insertion_point(field_list:cavnue.messages.data_warehouse.management.v1.FrameAnnotationBox3.actors)
  return _internal_actors();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField<::int64_t>* FrameAnnotationBox3::mutable_actors() {
  // @@protoc_insertion_point(field_mutable_list:cavnue.messages.data_warehouse.management.v1.FrameAnnotationBox3.actors)
  return _internal_mutable_actors();
}
...
inline const std::string& FrameAnnotationSegmentation_MaskMap::uri() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v1.FrameAnnotationSegmentation.MaskMap.uri)
...
inline PROTOBUF_ALWAYS_INLINE void FrameAnnotationSegmentation_MaskMap::set_uri(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v1.FrameAnnotationSegmentation.MaskMap.uri)
}
inline std::string* FrameAnnotationSegmentation_MaskMap::mutable_uri() {
  std::string* _s = _internal_mutable_uri();
  // @@protoc_insertion_point(field_mutable:cavnue.messages.data_warehouse.management.v1.FrameAnnotationSegmentation.MaskMap.uri)
  return _s;
}
...
inline std::string* FrameAnnotationSegmentation_MaskMap::release_uri() {
  // @@protoc_insertion_point(field_release:cavnue.messages.data_warehouse.management.v1.FrameAnnotationSegmentation.MaskMap.uri)
...
inline void FrameAnnotationSegmentation_MaskMap::set_allocated_uri(std::string* value) {
  ...
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:cavnue.messages.data_warehouse.management.v1.FrameAnnotationSegmentation.MaskMap.uri)
}
...
inline ::int64_t FrameAnnotationSegmentation_MaskMap::label_id() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v1.FrameAnnotationSegmentation.MaskMap.label_id)
...
inline void FrameAnnotationSegmentation_MaskMap::set_label_id(::int64_t value) {
  ...
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v1.FrameAnnotationSegmentation.MaskMap.label_id)
}
...
inline ::int64_t FrameAnnotationSegmentation::data_id() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v1.FrameAnnotationSegmentation.data_id)
  return _internal_data_id();
}
inline void FrameAnnotationSegmentation::set_data_id(::int64_t value) {
  _internal_set_data_id(value);
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v1.FrameAnnotationSegmentation.data_id)
}
...
inline ::int64_t FrameAnnotationSegmentation::batch_id() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v1.FrameAnnotationSegmentation.batch_id)
  return _internal_batch_id();
}
inline void FrameAnnotationSegmentation::set_batch_id(::int64_t value) {
  _internal_set_batch_id(value);
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v1.FrameAnnotationSegmentation.batch_id)
}
...
inline ::cavnue::messages::data_warehouse::management::v1::FrameAnnotationSegmentation_MaskMap* FrameAnnotationSegmentation::mutable_mask_map(int index) {
  // @@protoc_insertion_point(field_mutable:cavnue.messages.data_warehouse.management.v1.FrameAnnotationSegmentation.mask_map)
  return _internal_mutable_mask_map()->Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::cavnue::messages::data_warehouse::management::v1::FrameAnnotationSegmentation_MaskMap >*
FrameAnnotationSegmentation::mutable_mask_map() {
  // @@protoc_insertion_point(field_mutable_list:cavnue.messages.data_warehouse.management.v1.FrameAnnotationSegmentation.mask_map)
  return _internal_mutable_mask_map();
}
inline const ::cavnue::messages::data_warehouse::management::v1::FrameAnnotationSegmentation_MaskMap& FrameAnnotationSegmentation::_internal_mask_map(int index) const {
  return _internal_mask_map().Get(index);
}
inline const ::cavnue::messages::data_warehouse::management::v1::FrameAnnotationSegmentation_MaskMap& FrameAnnotationSegmentation::mask_map(int index) const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v1.FrameAnnotationSegmentation.mask_map)
  return _internal_mask_map(index);
}
inline ::cavnue::messages::data_warehouse::management::v1::FrameAnnotationSegmentation_MaskMap* FrameAnnotationSegmentation::_internal_add_mask_map() {
  return _internal_mutable_mask_map()->Add();
}
inline ::cavnue::messages::data_warehouse::management::v1::FrameAnnotationSegmentation_MaskMap* FrameAnnotationSegmentation::add_mask_map() {
  ::cavnue::messages::data_warehouse::management::v1::FrameAnnotationSegmentation_MaskMap* _add = _internal_add_mask_map();
  // @@protoc_insertion_point(field_add:cavnue.messages.data_warehouse.management.v1.FrameAnnotationSegmentation.mask_map)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::cavnue::messages::data_warehouse::management::v1::FrameAnnotationSegmentation_MaskMap >&
FrameAnnotationSegmentation::mask_map() const {
  // @@protoc_insertion_point(field_list:cavnue.messages.data_warehouse.management.v1.FrameAnnotationSegmentation.mask_map)
...
inline ::int64_t FrameAnnotationAttributes::data_id() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v1.FrameAnnotationAttributes.data_id)
  return _internal_data_id();
}
inline void FrameAnnotationAttributes::set_data_id(::int64_t value) {
  _internal_set_data_id(value);
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v1.FrameAnnotationAttributes.data_id)
}
...
inline ::int64_t FrameAnnotationAttributes::batch_id() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v1.FrameAnnotationAttributes.batch_id)
  return _internal_batch_id();
}
inline void FrameAnnotationAttributes::set_batch_id(::int64_t value) {
  _internal_set_batch_id(value);
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v1.FrameAnnotationAttributes.batch_id)
}
...
inline ::int64_t FrameAnnotationAttributes::actor_id() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v1.FrameAnnotationAttributes.actor_id)
  return _internal_actor_id();
}
inline void FrameAnnotationAttributes::set_actor_id(::int64_t value) {
  _internal_set_actor_id(value);
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v1.FrameAnnotationAttributes.actor_id)
}
...
inline bool FrameAnnotationAttributes::wrong_way_driving() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v1.FrameAnnotationAttributes.wrong_way_driving)
...
inline void FrameAnnotationAttributes::set_wrong_way_driving(bool value) {
  ...
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v1.FrameAnnotationAttributes.wrong_way_driving)
}
...
inline bool FrameAnnotationAttributes::impeding() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v1.FrameAnnotationAttributes.impeding)
  return _internal_impeding();
}
inline void FrameAnnotationAttributes::set_impeding(bool value) {
  _internal_set_impeding(value);
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v1.FrameAnnotationAttributes.impeding)
}
...
inline bool FrameAnnotationAttributes::collision() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v1.FrameAnnotationAttributes.collision)
  return _internal_collision();
}
inline void FrameAnnotationAttributes::set_collision(bool value) {
  _internal_set_collision(value);
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v1.FrameAnnotationAttributes.collision)
}
...
inline bool FrameAnnotationAttributes::speeding() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v1.FrameAnnotationAttributes.speeding)
  return _internal_speeding();
}
inline void FrameAnnotationAttributes::set_speeding(bool value) {
  _internal_set_speeding(value);
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v1.FrameAnnotationAttributes.speeding)
}
...
inline bool FrameAnnotationAttributes::siren() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v1.FrameAnnotationAttributes.siren)
  return _internal_siren();
}
inline void FrameAnnotationAttributes::set_siren(bool value) {
  _internal_set_siren(value);
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v1.FrameAnnotationAttributes.siren)
}
...
inline ::int64_t Label::label_id() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v1.Label.label_id)
  return _internal_label_id();
}
inline void Label::set_label_id(::int64_t value) {
  _internal_set_label_id(value);
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v1.Label.label_id)
}
...
inline const std::string& Label::annotation_type() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v1.Label.annotation_type)
...
inline PROTOBUF_ALWAYS_INLINE void Label::set_annotation_type(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v1.Label.annotation_type)
}
inline std::string* Label::mutable_annotation_type() {
  std::string* _s = _internal_mutable_annotation_type();
  // @@protoc_insertion_point(field_mutable:cavnue.messages.data_warehouse.management.v1.Label.annotation_type)
  return _s;
}
...
inline std::string* Label::release_annotation_type() {
  // @@protoc_insertion_point(field_release:cavnue.messages.data_warehouse.management.v1.Label.annotation_type)
  if ((_impl_._has_bits_[0] & 0x00000001u) == 0) {
    return nullptr;
  }
  _impl_._has_bits_[0] &= ~0x00000001u;
...
inline void Label::set_allocated_annotation_type(std::string* value) {
  ...
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:cavnue.messages.data_warehouse.management.v1.Label.annotation_type)
}
...
inline ::cavnue::messages::common::v1::Classification Label::label() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v1.Label.label)
  return _internal_label();
}
inline void Label::set_label(::cavnue::messages::common::v1::Classification value) {
   _internal_set_label(value);
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v1.Label.label)
}
...
inline std::string* Label::add_hierarchy() {
  ...
  // @@protoc_insertion_point(field_add_mutable:cavnue.messages.data_warehouse.management.v1.Label.hierarchy)
  return _s;
}
inline const std::string& Label::hierarchy(int index) const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v1.Label.hierarchy)
  return _internal_hierarchy(index);
}
inline std::string* Label::mutable_hierarchy(int index) {
  // @@protoc_insertion_point(field_mutable:cavnue.messages.data_warehouse.management.v1.Label.hierarchy)
...
inline void Label::set_hierarchy(int index, const std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v1.Label.hierarchy)
}
...
inline void Label::set_hierarchy(int index, const char* value) {
  ...
  _internal_mutable_hierarchy()->Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:cavnue.messages.data_warehouse.management.v1.Label.hierarchy)
}
inline void Label::set_hierarchy(int index, const char* value,
                              std::size_t size) {
  _internal_mutable_hierarchy()->Mutable(index)->assign(
      reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:cavnue.messages.data_warehouse.management.v1.Label.hierarchy)
}
inline void Label::set_hierarchy(int index, absl::string_view value) {
  _internal_mutable_hierarchy()->Mutable(index)->assign(value.data(),
                                                     value.size());
  // @@protoc_insertion_point(field_set_string_piece:cavnue.messages.data_warehouse.management.v1.Label.hierarchy)
}
inline void Label::add_hierarchy(const std::string& value) {
  _internal_mutable_hierarchy()->Add()->assign(value);
  // @@protoc_insertion_point(field_add:cavnue.messages.data_warehouse.management.v1.Label.hierarchy)
}
...
inline void Label::add_hierarchy(const char* value) {
  ABSL_DCHECK(value != nullptr);
  _internal_mutable_hierarchy()->Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:cavnue.messages.data_warehouse.management.v1.Label.hierarchy)
}
inline void Label::add_hierarchy(const char* value, std::size_t size) {
  _internal_mutable_hierarchy()->Add()->assign(
      reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:cavnue.messages.data_warehouse.management.v1.Label.hierarchy)
}
inline void Label::add_hierarchy(absl::string_view value) {
  _internal_mutable_hierarchy()->Add()->assign(value.data(), value.size());
  // @@protoc_insertion_point(field_add_string_piece:cavnue.messages.data_warehouse.management.v1.Label.hierarchy)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
Label::hierarchy() const {
  // @@protoc_insertion_point(field_list:cavnue.messages.data_warehouse.management.v1.Label.hierarchy)
  return _internal_hierarchy();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>* Label::mutable_hierarchy() {
  // @@protoc_insertion_point(field_mutable_list:cavnue.messages.data_warehouse.management.v1.Label.hierarchy)
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv1_2fannotations_2eproto_2epb_2eh
