...
static ::_pb::Metadata file_level_metadata_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv1_2fdatasets_2eproto[1];
static const ::_pb::EnumDescriptor* file_level_enum_descriptors_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv1_2fdatasets_2eproto[1];
static constexpr const ::_pb::ServiceDescriptor**
    file_level_service_descriptors_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv1_2fdatasets_2eproto = nullptr;
const ::uint32_t TableStruct_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv1_2fdatasets_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
    PROTOBUF_FIELD_OFFSET(::cavnue::messages::data_warehouse::management::v1::Dataset, _impl_._has_bits_),
    PROTOBUF_FIELD_OFFSET(::cavnue::messages::data_warehouse::management::v1::Dataset, _internal_metadata_),
    ~0u,  // no _extensions_
    ~0u,  // no _oneof_case_
    ...
    ~0u,  // no _split_
    ~0u,  // no sizeof(Split)
    PROTOBUF_FIELD_OFFSET(::cavnue::messages::data_warehouse::management::v1::Dataset, _impl_.dataset_id_),
    PROTOBUF_FIELD_OFFSET(::cavnue::messages::data_warehouse::management::v1::Dataset, _impl_.identifier_),
    PROTOBUF_FIELD_OFFSET(::cavnue::messages::data_warehouse::management::v1::Dataset, _impl_.project_id_),
    PROTOBUF_FIELD_OFFSET(::cavnue::messages::data_warehouse::management::v1::Dataset, _impl_.data_ids_),
    PROTOBUF_FIELD_OFFSET(::cavnue::messages::data_warehouse::management::v1::Dataset, _impl_.type_),
    PROTOBUF_FIELD_OFFSET(::cavnue::messages::data_warehouse::management::v1::Dataset, _impl_.start_ts_),
    PROTOBUF_FIELD_OFFSET(::cavnue::messages::data_warehouse::management::v1::Dataset, _impl_.end_ts_),
    PROTOBUF_FIELD_OFFSET(::cavnue::messages::data_warehouse::management::v1::Dataset, _impl_.sim_id_),
    PROTOBUF_FIELD_OFFSET(::cavnue::messages::data_warehouse::management::v1::Dataset, _impl_.cohort_id_),
    3,
    0,
    4,
    ~0u,
...
static const ::_pbi::MigrationSchema
    schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
        { 0, 17, -1, sizeof(::cavnue::messages::data_warehouse::management::v1::Dataset)},
};

static const ::_pb::Message* const file_default_instances[] = {
    &::cavnue::messages::data_warehouse::management::v1::_Dataset_default_instance_._instance,
};
const char descriptor_table_protodef_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv1_2fdatasets_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
    "\n;cavnue/messages/data_warehouse/managem"
    "ent/v1/datasets.proto\022,cavnue.messages.d"
    ...
    "ogle/protobuf/timestamp.proto\"\274\005\n\007Datase"
    ...
    "\nidentifier\210\001\001\022*\n\nproject_id\030\003 \001(\003B\006\212\371+\002"
    "\010\001H\002R\tprojectId\210\001\001\022\031\n\010data_ids\030\004 \003(\003R\007da"
    "taIds\022N\n\004type\030\005 \001(\0162:.cavnue.messages.da"
    "ta_warehouse.management.v1.Dataset.TypeR"
    "\004type\022M\n\010start_ts\030\006 \001(\0132\032.google.protobu"
    "f.TimestampB\021\212\371+\r\010\001\022\tTIMESTAMPH\003R\007startT"
    "s\210\001\001\022I\n\006end_ts\030\007 \001(\0132\032.google.protobuf.T"
    "imestampB\021\212\371+\r\010\001\022\tTIMESTAMPH\004R\005endTs\210\001\001\022"
    "\025\n\006sim_id\030\010 \001(\tR\005simId\022*\n\tcohort_id\030\t \001("
    "\003B\010\212\371+\004\010\001@\001H\005R\010cohortId\210\001\001\"}\n\004Type\022\024\n\020TY"
    "PE_UNSPECIFIED\020\000\022\021\n\rTYPE_SPEEDING\020\001\022\021\n\rT"
    "YPE_IMPEDING\020\002\022\023\n\017TYPE_STATIONARY\020\003\022\020\n\014T"
    "YPE_TRAFFIC\020\004\022\022\n\016TYPE_COLLISION\020\005:\016\202\371+\n\n"
    "\010DatasetsB\r\n\013_dataset_idB\r\n\013_identifierB"
    "\r\n\013_project_idB\013\n\t_start_tsB\t\n\007_end_tsB\014"
    "\n\n_cohort_idb\006proto3"
};
static const ::_pbi::DescriptorTable* const descriptor_table_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv1_2fdatasets_2eproto_deps[4] =
    {
...
static ::absl::once_flag descriptor_table_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv1_2fdatasets_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv1_2fdatasets_2eproto = {
    false,
    false,
    980,
    descriptor_table_protodef_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv1_2fdatasets_2eproto,
    "cavnue/messages/data_warehouse/management/v1/datasets.proto",
    &descriptor_table_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv1_2fdatasets_2eproto_once,
    descriptor_table_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv1_2fdatasets_2eproto_deps,
    4,
    1,
    schemas,
    file_default_instances,
    TableStruct_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv1_2fdatasets_2eproto::offsets,
    file_level_metadata_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv1_2fdatasets_2eproto,
    file_level_enum_descriptors_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv1_2fdatasets_2eproto,
    file_level_service_descriptors_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv1_2fdatasets_2eproto,
};
...
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv1_2fdatasets_2eproto_getter() {
  return &descriptor_table_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv1_2fdatasets_2eproto;
}
// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2
static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv1_2fdatasets_2eproto(&descriptor_table_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv1_2fdatasets_2eproto);
namespace cavnue {
namespace messages {
namespace data_warehouse {
namespace management {
...
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* Dataset_Type_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv1_2fdatasets_2eproto);
  return file_level_enum_descriptors_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv1_2fdatasets_2eproto[0];
}
...
Dataset::Dataset(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:cavnue.messages.data_warehouse.management.v1.Dataset)
}
Dataset::Dataset(const Dataset& from)
  ...
  // @@protoc_insertion_point(copy_constructor:cavnue.messages.data_warehouse.management.v1.Dataset)
}
...
Dataset::~Dataset() {
  // @@protoc_insertion_point(destructor:cavnue.messages.data_warehouse.management.v1.Dataset)
...
void Dataset::Clear() {
// @@protoc_insertion_point(message_clear_start:cavnue.messages.data_warehouse.management.v1.Dataset)
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 18)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "cavnue.messages.data_warehouse.management.v1.Dataset.identifier"));
        } else {
          goto handle_unusual;
        }
        continue;
      // optional int64 project_id = 3 [json_name = "projectId", (.gen_bq_schema.bigquery) = {
      case 3:
      ...
      case 4:
        ...
        continue;
      // .cavnue.messages.data_warehouse.management.v1.Dataset.Type type = 5 [json_name = "type"];
      case 5:
      ...
      case 8:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 66)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "cavnue.messages.data_warehouse.management.v1.Dataset.sim_id"));
        } else {
          goto handle_unusual;
        }
        continue;
...
::uint8_t* Dataset::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:cavnue.messages.data_warehouse.management.v1.Dataset)
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (cached_has_bits & 0x00000001u) {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE, "cavnue.messages.data_warehouse.management.v1.Dataset.identifier");
  ...
  if (!this->_internal_sim_id().empty()) {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE, "cavnue.messages.data_warehouse.management.v1.Dataset.sim_id");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:cavnue.messages.data_warehouse.management.v1.Dataset)
  return target;
}

::size_t Dataset::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:cavnue.messages.data_warehouse.management.v1.Dataset)
  ::size_t total_size = 0;
...
void Dataset::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:cavnue.messages.data_warehouse.management.v1.Dataset)
...
// @@protoc_insertion_point(class_specific_copy_from_start:cavnue.messages.data_warehouse.management.v1.Dataset)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata Dataset::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv1_2fdatasets_2eproto_getter, &descriptor_table_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv1_2fdatasets_2eproto_once,
      file_level_metadata_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv1_2fdatasets_2eproto[0]);
}
...
template<> PROTOBUF_NOINLINE ::cavnue::messages::data_warehouse::management::v1::Dataset*
Arena::CreateMaybeMessage< ::cavnue::messages::data_warehouse::management::v1::Dataset >(Arena* arena) {
  return Arena::CreateMessageInternal< ::cavnue::messages::data_warehouse::management::v1::Dataset >(arena);
}
