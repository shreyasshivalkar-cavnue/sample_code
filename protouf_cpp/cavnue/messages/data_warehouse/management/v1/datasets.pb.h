...
#ifndef GOOGLE_PROTOBUF_INCLUDED_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv1_2fdatasets_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv1_2fdatasets_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv1_2fdatasets_2eproto
...
struct TableStruct_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv1_2fdatasets_2eproto {
...
PROTOBUF_NAMESPACE_OPEN
template <>
::cavnue::messages::data_warehouse::management::v1::Dataset* Arena::CreateMaybeMessage<::cavnue::messages::data_warehouse::management::v1::Dataset>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class Dataset final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:cavnue.messages.data_warehouse.management.v1.Dataset) */ {
 public:
  ...
  static ::absl::string_view FullMessageName() {
    return "cavnue.messages.data_warehouse.management.v1.Dataset";
  }
  protected:
  ...
  public:
  // @@protoc_insertion_point(class_scope:cavnue.messages.data_warehouse.management.v1.Dataset)
 private:
  class _Internal;
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv1_2fdatasets_2eproto;
};
...
inline ::int64_t Dataset::dataset_id() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v1.Dataset.dataset_id)
  return _internal_dataset_id();
}
inline void Dataset::set_dataset_id(::int64_t value) {
  _internal_set_dataset_id(value);
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v1.Dataset.dataset_id)
}
...
inline const std::string& Dataset::identifier() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v1.Dataset.identifier)
...
inline PROTOBUF_ALWAYS_INLINE void Dataset::set_identifier(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v1.Dataset.identifier)
}
inline std::string* Dataset::mutable_identifier() {
  std::string* _s = _internal_mutable_identifier();
  // @@protoc_insertion_point(field_mutable:cavnue.messages.data_warehouse.management.v1.Dataset.identifier)
  return _s;
}
...
inline std::string* Dataset::release_identifier() {
  // @@protoc_insertion_point(field_release:cavnue.messages.data_warehouse.management.v1.Dataset.identifier)
...
inline void Dataset::set_allocated_identifier(std::string* value) {
  ...
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:cavnue.messages.data_warehouse.management.v1.Dataset.identifier)
}

// optional int64 project_id = 3 [json_name = "projectId", (.gen_bq_schema.bigquery) = {
inline bool Dataset::has_project_id() const {
...
inline ::int64_t Dataset::project_id() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v1.Dataset.project_id)
  return _internal_project_id();
}
inline void Dataset::set_project_id(::int64_t value) {
  _internal_set_project_id(value);
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v1.Dataset.project_id)
}
inline ::int64_t Dataset::_internal_project_id() const {
  return _impl_.project_id_;
}
inline void Dataset::_internal_set_project_id(::int64_t value) {
  _impl_._has_bits_[0] |= 0x00000010u;
...
inline ::int64_t Dataset::data_ids(int index) const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v1.Dataset.data_ids)
...
inline void Dataset::set_data_ids(int index, ::int64_t value) {
  ...
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v1.Dataset.data_ids)
}
inline void Dataset::add_data_ids(::int64_t value) {
  _internal_add_data_ids(value);
  // @@protoc_insertion_point(field_add:cavnue.messages.data_warehouse.management.v1.Dataset.data_ids)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField<::int64_t>& Dataset::data_ids() const {
  // @@protoc_insertion_point(field_list:cavnue.messages.data_warehouse.management.v1.Dataset.data_ids)
  return _internal_data_ids();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField<::int64_t>* Dataset::mutable_data_ids() {
  // @@protoc_insertion_point(field_mutable_list:cavnue.messages.data_warehouse.management.v1.Dataset.data_ids)
...
inline ::cavnue::messages::data_warehouse::management::v1::Dataset_Type Dataset::type() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v1.Dataset.type)
  return _internal_type();
}
inline void Dataset::set_type(::cavnue::messages::data_warehouse::management::v1::Dataset_Type value) {
   _internal_set_type(value);
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v1.Dataset.type)
}
inline ::cavnue::messages::data_warehouse::management::v1::Dataset_Type Dataset::_internal_type() const {
  return static_cast<::cavnue::messages::data_warehouse::management::v1::Dataset_Type>(_impl_.type_);
}
inline void Dataset::_internal_set_type(::cavnue::messages::data_warehouse::management::v1::Dataset_Type value) {
  ;
  _impl_.type_ = value;
}
...
inline const ::PROTOBUF_NAMESPACE_ID::Timestamp& Dataset::start_ts() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v1.Dataset.start_ts)
...
inline void Dataset::unsafe_arena_set_allocated_start_ts(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:cavnue.messages.data_warehouse.management.v1.Dataset.start_ts)
}
...
inline ::PROTOBUF_NAMESPACE_ID::Timestamp* Dataset::unsafe_arena_release_start_ts() {
  // @@protoc_insertion_point(field_release:cavnue.messages.data_warehouse.management.v1.Dataset.start_ts)
  _impl_._has_bits_[0] &= ~0x00000002u;
  ::PROTOBUF_NAMESPACE_ID::Timestamp* temp = _impl_.start_ts_;
  _impl_.start_ts_ = nullptr;
  return temp;
...
inline ::PROTOBUF_NAMESPACE_ID::Timestamp* Dataset::mutable_start_ts() {
  ...
  // @@protoc_insertion_point(field_mutable:cavnue.messages.data_warehouse.management.v1.Dataset.start_ts)
  return _msg;
}
inline void Dataset::set_allocated_start_ts(::PROTOBUF_NAMESPACE_ID::Timestamp* start_ts) {
  ...
  _impl_.start_ts_ = start_ts;
  // @@protoc_insertion_point(field_set_allocated:cavnue.messages.data_warehouse.management.v1.Dataset.start_ts)
}
...
inline const ::PROTOBUF_NAMESPACE_ID::Timestamp& Dataset::end_ts() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v1.Dataset.end_ts)
...
inline void Dataset::unsafe_arena_set_allocated_end_ts(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:cavnue.messages.data_warehouse.management.v1.Dataset.end_ts)
}
...
inline ::PROTOBUF_NAMESPACE_ID::Timestamp* Dataset::unsafe_arena_release_end_ts() {
  // @@protoc_insertion_point(field_release:cavnue.messages.data_warehouse.management.v1.Dataset.end_ts)
  _impl_._has_bits_[0] &= ~0x00000004u;
  ::PROTOBUF_NAMESPACE_ID::Timestamp* temp = _impl_.end_ts_;
  _impl_.end_ts_ = nullptr;
  return temp;
...
inline ::PROTOBUF_NAMESPACE_ID::Timestamp* Dataset::mutable_end_ts() {
  ...
  // @@protoc_insertion_point(field_mutable:cavnue.messages.data_warehouse.management.v1.Dataset.end_ts)
  return _msg;
}
inline void Dataset::set_allocated_end_ts(::PROTOBUF_NAMESPACE_ID::Timestamp* end_ts) {
  ...
  _impl_.end_ts_ = end_ts;
  // @@protoc_insertion_point(field_set_allocated:cavnue.messages.data_warehouse.management.v1.Dataset.end_ts)
}
...
inline const std::string& Dataset::sim_id() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v1.Dataset.sim_id)
...
inline PROTOBUF_ALWAYS_INLINE void Dataset::set_sim_id(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v1.Dataset.sim_id)
}
inline std::string* Dataset::mutable_sim_id() {
  std::string* _s = _internal_mutable_sim_id();
  // @@protoc_insertion_point(field_mutable:cavnue.messages.data_warehouse.management.v1.Dataset.sim_id)
  return _s;
}
...
inline std::string* Dataset::release_sim_id() {
  // @@protoc_insertion_point(field_release:cavnue.messages.data_warehouse.management.v1.Dataset.sim_id)
...
inline void Dataset::set_allocated_sim_id(std::string* value) {
  ...
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:cavnue.messages.data_warehouse.management.v1.Dataset.sim_id)
}
...
inline ::int64_t Dataset::cohort_id() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v1.Dataset.cohort_id)
  return _internal_cohort_id();
}
inline void Dataset::set_cohort_id(::int64_t value) {
  _internal_set_cohort_id(value);
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v1.Dataset.cohort_id)
}
...
template <>
struct is_proto_enum<::cavnue::messages::data_warehouse::management::v1::Dataset_Type> : std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor<::cavnue::messages::data_warehouse::management::v1::Dataset_Type>() {
  return ::cavnue::messages::data_warehouse::management::v1::Dataset_Type_descriptor();
}
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv1_2fdatasets_2eproto_2epb_2eh
