...
#include "cavnue/messages/data_warehouse/management/v2/vehicle_state.pb.h"
...
static ::_pb::Metadata file_level_metadata_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv2_2fvehicle_5fstate_2eproto[1];
static constexpr const ::_pb::EnumDescriptor**
    file_level_enum_descriptors_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv2_2fvehicle_5fstate_2eproto = nullptr;
static constexpr const ::_pb::ServiceDescriptor**
    file_level_service_descriptors_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv2_2fvehicle_5fstate_2eproto = nullptr;
const ::uint32_t TableStruct_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv2_2fvehicle_5fstate_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
    PROTOBUF_FIELD_OFFSET(::cavnue::messages::data_warehouse::management::v2::VehicleState, _impl_._has_bits_),
    PROTOBUF_FIELD_OFFSET(::cavnue::messages::data_warehouse::management::v2::VehicleState, _internal_metadata_),
    ~0u,  // no _extensions_
    ~0u,  // no _oneof_case_
    ...
    ~0u,  // no _split_
    ~0u,  // no sizeof(Split)
    PROTOBUF_FIELD_OFFSET(::cavnue::messages::data_warehouse::management::v2::VehicleState, _impl_.uuid_),
    PROTOBUF_FIELD_OFFSET(::cavnue::messages::data_warehouse::management::v2::VehicleState, _impl_.test_run_id_),
    PROTOBUF_FIELD_OFFSET(::cavnue::messages::data_warehouse::management::v2::VehicleState, _impl_.test_artifact_id_),
    PROTOBUF_FIELD_OFFSET(::cavnue::messages::data_warehouse::management::v2::VehicleState, _impl_.cohort_id_),
    PROTOBUF_FIELD_OFFSET(::cavnue::messages::data_warehouse::management::v2::VehicleState, _impl_.ts_),
    PROTOBUF_FIELD_OFFSET(::cavnue::messages::data_warehouse::management::v2::VehicleState, _impl_.asset_role_),
    PROTOBUF_FIELD_OFFSET(::cavnue::messages::data_warehouse::management::v2::VehicleState, _impl_.heading_),
    PROTOBUF_FIELD_OFFSET(::cavnue::messages::data_warehouse::management::v2::VehicleState, _impl_.coordinate_),
    PROTOBUF_FIELD_OFFSET(::cavnue::messages::data_warehouse::management::v2::VehicleState, _impl_.velocity_quality_),
    PROTOBUF_FIELD_OFFSET(::cavnue::messages::data_warehouse::management::v2::VehicleState, _impl_.longitudinal_velocity_),
    PROTOBUF_FIELD_OFFSET(::cavnue::messages::data_warehouse::management::v2::VehicleState, _impl_.lateral_velocity_),
    PROTOBUF_FIELD_OFFSET(::cavnue::messages::data_warehouse::management::v2::VehicleState, _impl_.vertical_velocity_),
    PROTOBUF_FIELD_OFFSET(::cavnue::messages::data_warehouse::management::v2::VehicleState, _impl_.longitudinal_acceleration_),
    PROTOBUF_FIELD_OFFSET(::cavnue::messages::data_warehouse::management::v2::VehicleState, _impl_.lateral_acceleration_),
    PROTOBUF_FIELD_OFFSET(::cavnue::messages::data_warehouse::management::v2::VehicleState, _impl_.x_pos_),
    PROTOBUF_FIELD_OFFSET(::cavnue::messages::data_warehouse::management::v2::VehicleState, _impl_.y_pos_),
    PROTOBUF_FIELD_OFFSET(::cavnue::messages::data_warehouse::management::v2::VehicleState, _impl_.rms_hpos_),
    PROTOBUF_FIELD_OFFSET(::cavnue::messages::data_warehouse::management::v2::VehicleState, _impl_.rms_vpos_),
    PROTOBUF_FIELD_OFFSET(::cavnue::messages::data_warehouse::management::v2::VehicleState, _impl_.rms_hvel_),
    PROTOBUF_FIELD_OFFSET(::cavnue::messages::data_warehouse::management::v2::VehicleState, _impl_.rms_vvel_),
    PROTOBUF_FIELD_OFFSET(::cavnue::messages::data_warehouse::management::v2::VehicleState, _impl_.true_heading_),
    PROTOBUF_FIELD_OFFSET(::cavnue::messages::data_warehouse::management::v2::VehicleState, _impl_.pitchrate_),
    PROTOBUF_FIELD_OFFSET(::cavnue::messages::data_warehouse::management::v2::VehicleState, _impl_.rollrate_),
    PROTOBUF_FIELD_OFFSET(::cavnue::messages::data_warehouse::management::v2::VehicleState, _impl_.yawrate_),
    PROTOBUF_FIELD_OFFSET(::cavnue::messages::data_warehouse::management::v2::VehicleState, _impl_.height_),
    PROTOBUF_FIELD_OFFSET(::cavnue::messages::data_warehouse::management::v2::VehicleState, _impl_.dataset_id_),
    PROTOBUF_FIELD_OFFSET(::cavnue::messages::data_warehouse::management::v2::VehicleState, _impl_.run_ts_),
    PROTOBUF_FIELD_OFFSET(::cavnue::messages::data_warehouse::management::v2::VehicleState, _impl_.test_asset_id_),
    3,
    4,
    5,
    6,
...
static const ::_pbi::MigrationSchema
    schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
        { 0, 36, -1, sizeof(::cavnue::messages::data_warehouse::management::v2::VehicleState)},
};

static const ::_pb::Message* const file_default_instances[] = {
    &::cavnue::messages::data_warehouse::management::v2::_VehicleState_default_instance_._instance,
};
const char descriptor_table_protodef_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv2_2fvehicle_5fstate_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
    "\n@cavnue/messages/data_warehouse/managem"
    "ent/v2/vehicle_state.proto\022,cavnue.messa"
    "ges.data_warehouse.management.v2\032\'cavnue"
...
static const ::_pbi::DescriptorTable* const descriptor_table_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv2_2fvehicle_5fstate_2eproto_deps[4] =
    {
...
static ::absl::once_flag descriptor_table_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv2_2fvehicle_5fstate_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv2_2fvehicle_5fstate_2eproto = {
    false,
    false,
    2146,
    descriptor_table_protodef_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv2_2fvehicle_5fstate_2eproto,
    "cavnue/messages/data_warehouse/management/v2/vehicle_state.proto",
    &descriptor_table_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv2_2fvehicle_5fstate_2eproto_once,
    descriptor_table_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv2_2fvehicle_5fstate_2eproto_deps,
    4,
    1,
    schemas,
    file_default_instances,
    TableStruct_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv2_2fvehicle_5fstate_2eproto::offsets,
    file_level_metadata_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv2_2fvehicle_5fstate_2eproto,
    file_level_enum_descriptors_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv2_2fvehicle_5fstate_2eproto,
    file_level_service_descriptors_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv2_2fvehicle_5fstate_2eproto,
};
...
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv2_2fvehicle_5fstate_2eproto_getter() {
  return &descriptor_table_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv2_2fvehicle_5fstate_2eproto;
}
// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2
static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv2_2fvehicle_5fstate_2eproto(&descriptor_table_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv2_2fvehicle_5fstate_2eproto);
namespace cavnue {
namespace messages {
namespace data_warehouse {
namespace management {
...
VehicleState::VehicleState(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:cavnue.messages.data_warehouse.management.v2.VehicleState)
}
VehicleState::VehicleState(const VehicleState& from)
  ...
  // @@protoc_insertion_point(copy_constructor:cavnue.messages.data_warehouse.management.v2.VehicleState)
}
...
VehicleState::~VehicleState() {
  // @@protoc_insertion_point(destructor:cavnue.messages.data_warehouse.management.v2.VehicleState)
...
// @@protoc_insertion_point(message_clear_start:cavnue.messages.data_warehouse.management.v2.VehicleState)
    ...
    switch (tag >> 3) {
      ...
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 50)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "cavnue.messages.data_warehouse.management.v2.VehicleState.asset_role"));
        } else {
          goto handle_unusual;
        }
        continue;
      ...
      case 8:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 66)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "cavnue.messages.data_warehouse.management.v2.VehicleState.coordinate"));
        } else {
          goto handle_unusual;
        }
        continue;
...
::uint8_t* VehicleState::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:cavnue.messages.data_warehouse.management.v2.VehicleState)
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (!this->_internal_asset_role().empty()) {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE, "cavnue.messages.data_warehouse.management.v2.VehicleState.asset_role");
  ...
  if (cached_has_bits & 0x00000001u) {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE, "cavnue.messages.data_warehouse.management.v2.VehicleState.coordinate");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:cavnue.messages.data_warehouse.management.v2.VehicleState)
  return target;
}

::size_t VehicleState::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:cavnue.messages.data_warehouse.management.v2.VehicleState)
  ::size_t total_size = 0;
...
void VehicleState::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:cavnue.messages.data_warehouse.management.v2.VehicleState)
...
// @@protoc_insertion_point(class_specific_copy_from_start:cavnue.messages.data_warehouse.management.v2.VehicleState)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata VehicleState::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv2_2fvehicle_5fstate_2eproto_getter, &descriptor_table_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv2_2fvehicle_5fstate_2eproto_once,
      file_level_metadata_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv2_2fvehicle_5fstate_2eproto[0]);
}
...
template<> PROTOBUF_NOINLINE ::cavnue::messages::data_warehouse::management::v2::VehicleState*
Arena::CreateMaybeMessage< ::cavnue::messages::data_warehouse::management::v2::VehicleState >(Arena* arena) {
  return Arena::CreateMessageInternal< ::cavnue::messages::data_warehouse::management::v2::VehicleState >(arena);
}
