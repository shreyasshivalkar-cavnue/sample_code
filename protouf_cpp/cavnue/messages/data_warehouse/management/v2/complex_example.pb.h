...
#ifndef GOOGLE_PROTOBUF_INCLUDED_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv2_2fcomplex_5fexample_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv2_2fcomplex_5fexample_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv2_2fcomplex_5fexample_2eproto
...
struct TableStruct_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv2_2fcomplex_5fexample_2eproto {
  static const ::uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable
    descriptor_table_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv2_2fcomplex_5fexample_2eproto;
namespace cavnue {
namespace messages {
...
PROTOBUF_NAMESPACE_OPEN
template <>
::cavnue::messages::data_warehouse::management::v2::ComplexMessage* Arena::CreateMaybeMessage<::cavnue::messages::data_warehouse::management::v2::ComplexMessage>(Arena*);
template <>
::cavnue::messages::data_warehouse::management::v2::ComplexMessage_MapFieldEntry_DoNotUse* Arena::CreateMaybeMessage<::cavnue::messages::data_warehouse::management::v2::ComplexMessage_MapFieldEntry_DoNotUse>(Arena*);
template <>
::cavnue::messages::data_warehouse::management::v2::CustomMetadata* Arena::CreateMaybeMessage<::cavnue::messages::data_warehouse::management::v2::CustomMetadata>(Arena*);
template <>
::cavnue::messages::data_warehouse::management::v2::NestedMessage* Arena::CreateMaybeMessage<::cavnue::messages::data_warehouse::management::v2::NestedMessage>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class NestedMessage final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:cavnue.messages.data_warehouse.management.v2.NestedMessage) */ {
 public:
  ...
  static ::absl::string_view FullMessageName() {
    return "cavnue.messages.data_warehouse.management.v2.NestedMessage";
  }
  protected:
  ...
  public:
  // @@protoc_insertion_point(class_scope:cavnue.messages.data_warehouse.management.v2.NestedMessage)
 private:
  class _Internal;
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv2_2fcomplex_5fexample_2eproto;
};// -------------------------------------------------------------------

class CustomMetadata final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:cavnue.messages.data_warehouse.management.v2.CustomMetadata) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() {
    return "cavnue.messages.data_warehouse.management.v2.CustomMetadata";
  }
  protected:
  ...
  public:
  // @@protoc_insertion_point(class_scope:cavnue.messages.data_warehouse.management.v2.CustomMetadata)
 private:
  class _Internal;
...
class ComplexMessage_MapFieldEntry_DoNotUse final : public ::PROTOBUF_NAMESPACE_ID::internal::MapEntry<ComplexMessage_MapFieldEntry_DoNotUse, 
    std::string, ::cavnue::messages::data_warehouse::management::v2::NestedMessage,
...
public:
  ...
  static bool ValidateKey(std::string* s) {
    return ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(s->data(), static_cast<int>(s->size()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::PARSE, "cavnue.messages.data_warehouse.management.v2.ComplexMessage.MapFieldEntry.key");
 }
...
class ComplexMessage final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:cavnue.messages.data_warehouse.management.v2.ComplexMessage) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() {
    return "cavnue.messages.data_warehouse.management.v2.ComplexMessage";
  }
  protected:
  ...
  public:
  // map<string, .cavnue.messages.data_warehouse.management.v2.NestedMessage> map_field = 18 [json_name = "mapField"];
  ...
  private:
  const ::PROTOBUF_NAMESPACE_ID::Map< std::string, ::cavnue::messages::data_warehouse::management::v2::NestedMessage >&
      _internal_map_field() const;
  ::PROTOBUF_NAMESPACE_ID::Map< std::string, ::cavnue::messages::data_warehouse::management::v2::NestedMessage >*
  ...
  public:
  // .cavnue.messages.data_warehouse.management.v2.NestedMessage nested_message_field = 21 [json_name = "nestedMessageField"];
  bool has_nested_message_field() const;
  void clear_nested_message_field() ;
  const ::cavnue::messages::data_warehouse::management::v2::NestedMessage& nested_message_field() const;
  PROTOBUF_NODISCARD ::cavnue::messages::data_warehouse::management::v2::NestedMessage* release_nested_message_field();
  ::cavnue::messages::data_warehouse::management::v2::NestedMessage* mutable_nested_message_field();
  void set_allocated_nested_message_field(::cavnue::messages::data_warehouse::management::v2::NestedMessage* nested_message_field);
  private:
  const ::cavnue::messages::data_warehouse::management::v2::NestedMessage& _internal_nested_message_field() const;
  ::cavnue::messages::data_warehouse::management::v2::NestedMessage* _internal_mutable_nested_message_field();
  public:
  void unsafe_arena_set_allocated_nested_message_field(
      ::cavnue::messages::data_warehouse::management::v2::NestedMessage* nested_message_field);
  ::cavnue::messages::data_warehouse::management::v2::NestedMessage* unsafe_arena_release_nested_message_field();
  ...
  // .cavnue.messages.data_warehouse.management.v2.CustomMetadata custom_metadata = 24 [json_name = "customMetadata"];
  bool has_custom_metadata() const;
  void clear_custom_metadata() ;
  const ::cavnue::messages::data_warehouse::management::v2::CustomMetadata& custom_metadata() const;
  PROTOBUF_NODISCARD ::cavnue::messages::data_warehouse::management::v2::CustomMetadata* release_custom_metadata();
  ::cavnue::messages::data_warehouse::management::v2::CustomMetadata* mutable_custom_metadata();
  void set_allocated_custom_metadata(::cavnue::messages::data_warehouse::management::v2::CustomMetadata* custom_metadata);
  private:
  const ::cavnue::messages::data_warehouse::management::v2::CustomMetadata& _internal_custom_metadata() const;
  ::cavnue::messages::data_warehouse::management::v2::CustomMetadata* _internal_mutable_custom_metadata();
  public:
  void unsafe_arena_set_allocated_custom_metadata(
      ::cavnue::messages::data_warehouse::management::v2::CustomMetadata* custom_metadata);
  ::cavnue::messages::data_warehouse::management::v2::CustomMetadata* unsafe_arena_release_custom_metadata();
  ...
  public:
  // .cavnue.messages.data_warehouse.management.v2.ExampleEnum enum_field = 16 [json_name = "enumField"];
  void clear_enum_field() ;
  ::cavnue::messages::data_warehouse::management::v2::ExampleEnum enum_field() const;
  void set_enum_field(::cavnue::messages::data_warehouse::management::v2::ExampleEnum value);

  private:
  ::cavnue::messages::data_warehouse::management::v2::ExampleEnum _internal_enum_field() const;
  void _internal_set_enum_field(::cavnue::messages::data_warehouse::management::v2::ExampleEnum value);
  ...
  public:
  // .cavnue.messages.data_warehouse.management.v2.NestedMessage oneof_nested_message = 20 [json_name = "oneofNestedMessage"];
  ...
  const ::cavnue::messages::data_warehouse::management::v2::NestedMessage& oneof_nested_message() const;
  PROTOBUF_NODISCARD ::cavnue::messages::data_warehouse::management::v2::NestedMessage* release_oneof_nested_message();
  ::cavnue::messages::data_warehouse::management::v2::NestedMessage* mutable_oneof_nested_message();
  void set_allocated_oneof_nested_message(::cavnue::messages::data_warehouse::management::v2::NestedMessage* oneof_nested_message);
  private:
  const ::cavnue::messages::data_warehouse::management::v2::NestedMessage& _internal_oneof_nested_message() const;
  ::cavnue::messages::data_warehouse::management::v2::NestedMessage* _internal_mutable_oneof_nested_message();
  public:
  void unsafe_arena_set_allocated_oneof_nested_message(
      ::cavnue::messages::data_warehouse::management::v2::NestedMessage* oneof_nested_message);
  ::cavnue::messages::data_warehouse::management::v2::NestedMessage* unsafe_arena_release_oneof_nested_message();
  void clear_test_oneof();
  TestOneofCase test_oneof_case() const;
  // @@protoc_insertion_point(class_scope:cavnue.messages.data_warehouse.management.v2.ComplexMessage)
 private:
  class _Internal;
  ...
  struct Impl_ {
    ...
    ::cavnue::messages::data_warehouse::management::v2::NestedMessage* nested_message_field_;
    ::PROTOBUF_NAMESPACE_ID::Timestamp* timestamp_field_;
    ::PROTOBUF_NAMESPACE_ID::Duration* duration_field_;
    ::cavnue::messages::data_warehouse::management::v2::CustomMetadata* custom_metadata_;
    ...
    union TestOneofUnion {
      ...
      ::cavnue::messages::data_warehouse::management::v2::NestedMessage* oneof_nested_message_;
    } test_oneof_;
...
inline ::int32_t NestedMessage::id() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v2.NestedMessage.id)
  return _internal_id();
}
inline void NestedMessage::set_id(::int32_t value) {
  _internal_set_id(value);
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v2.NestedMessage.id)
}
...
inline const std::string& NestedMessage::name() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v2.NestedMessage.name)
...
inline PROTOBUF_ALWAYS_INLINE void NestedMessage::set_name(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v2.NestedMessage.name)
}
inline std::string* NestedMessage::mutable_name() {
  std::string* _s = _internal_mutable_name();
  // @@protoc_insertion_point(field_mutable:cavnue.messages.data_warehouse.management.v2.NestedMessage.name)
  return _s;
}
...
inline std::string* NestedMessage::release_name() {
  // @@protoc_insertion_point(field_release:cavnue.messages.data_warehouse.management.v2.NestedMessage.name)
...
inline void NestedMessage::set_allocated_name(std::string* value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:cavnue.messages.data_warehouse.management.v2.NestedMessage.name)
}
...
inline std::string* NestedMessage::add_tags() {
  ...
  // @@protoc_insertion_point(field_add_mutable:cavnue.messages.data_warehouse.management.v2.NestedMessage.tags)
  return _s;
}
inline const std::string& NestedMessage::tags(int index) const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v2.NestedMessage.tags)
  return _internal_tags(index);
}
inline std::string* NestedMessage::mutable_tags(int index) {
  // @@protoc_insertion_point(field_mutable:cavnue.messages.data_warehouse.management.v2.NestedMessage.tags)
...
inline void NestedMessage::set_tags(int index, const std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v2.NestedMessage.tags)
}
...
inline void NestedMessage::set_tags(int index, const char* value) {
  ...
  _internal_mutable_tags()->Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:cavnue.messages.data_warehouse.management.v2.NestedMessage.tags)
}
inline void NestedMessage::set_tags(int index, const char* value,
                              std::size_t size) {
  _internal_mutable_tags()->Mutable(index)->assign(
      reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:cavnue.messages.data_warehouse.management.v2.NestedMessage.tags)
}
inline void NestedMessage::set_tags(int index, absl::string_view value) {
  _internal_mutable_tags()->Mutable(index)->assign(value.data(),
                                                     value.size());
  // @@protoc_insertion_point(field_set_string_piece:cavnue.messages.data_warehouse.management.v2.NestedMessage.tags)
}
inline void NestedMessage::add_tags(const std::string& value) {
  _internal_mutable_tags()->Add()->assign(value);
  // @@protoc_insertion_point(field_add:cavnue.messages.data_warehouse.management.v2.NestedMessage.tags)
}
...
inline void NestedMessage::add_tags(const char* value) {
  ABSL_DCHECK(value != nullptr);
  _internal_mutable_tags()->Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:cavnue.messages.data_warehouse.management.v2.NestedMessage.tags)
}
inline void NestedMessage::add_tags(const char* value, std::size_t size) {
  _internal_mutable_tags()->Add()->assign(
      reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:cavnue.messages.data_warehouse.management.v2.NestedMessage.tags)
}
inline void NestedMessage::add_tags(absl::string_view value) {
  _internal_mutable_tags()->Add()->assign(value.data(), value.size());
  // @@protoc_insertion_point(field_add_string_piece:cavnue.messages.data_warehouse.management.v2.NestedMessage.tags)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
NestedMessage::tags() const {
  // @@protoc_insertion_point(field_list:cavnue.messages.data_warehouse.management.v2.NestedMessage.tags)
  return _internal_tags();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>* NestedMessage::mutable_tags() {
  // @@protoc_insertion_point(field_mutable_list:cavnue.messages.data_warehouse.management.v2.NestedMessage.tags)
...
inline const std::string& CustomMetadata::message() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v2.CustomMetadata.message)
...
inline PROTOBUF_ALWAYS_INLINE void CustomMetadata::set_message(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v2.CustomMetadata.message)
}
inline std::string* CustomMetadata::mutable_message() {
  std::string* _s = _internal_mutable_message();
  // @@protoc_insertion_point(field_mutable:cavnue.messages.data_warehouse.management.v2.CustomMetadata.message)
  return _s;
}
...
inline std::string* CustomMetadata::release_message() {
  // @@protoc_insertion_point(field_release:cavnue.messages.data_warehouse.management.v2.CustomMetadata.message)
...
inline void CustomMetadata::set_allocated_message(std::string* value) {
  ...
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:cavnue.messages.data_warehouse.management.v2.CustomMetadata.message)
}
...
inline ::int32_t ComplexMessage::int_field() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v2.ComplexMessage.int_field)
  return _internal_int_field();
}
inline void ComplexMessage::set_int_field(::int32_t value) {
  _internal_set_int_field(value);
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v2.ComplexMessage.int_field)
}
...
inline ::int64_t ComplexMessage::int64_field() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v2.ComplexMessage.int64_field)
  return _internal_int64_field();
}
inline void ComplexMessage::set_int64_field(::int64_t value) {
  _internal_set_int64_field(value);
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v2.ComplexMessage.int64_field)
}
...
inline ::uint32_t ComplexMessage::uint_field() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v2.ComplexMessage.uint_field)
  return _internal_uint_field();
}
inline void ComplexMessage::set_uint_field(::uint32_t value) {
  _internal_set_uint_field(value);
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v2.ComplexMessage.uint_field)
}
...
inline ::uint64_t ComplexMessage::uint64_field() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v2.ComplexMessage.uint64_field)
  return _internal_uint64_field();
}
inline void ComplexMessage::set_uint64_field(::uint64_t value) {
  _internal_set_uint64_field(value);
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v2.ComplexMessage.uint64_field)
}
...
inline ::int32_t ComplexMessage::sint_field() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v2.ComplexMessage.sint_field)
  return _internal_sint_field();
}
inline void ComplexMessage::set_sint_field(::int32_t value) {
  _internal_set_sint_field(value);
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v2.ComplexMessage.sint_field)
}
...
inline ::int64_t ComplexMessage::sint64_field() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v2.ComplexMessage.sint64_field)
  return _internal_sint64_field();
}
inline void ComplexMessage::set_sint64_field(::int64_t value) {
  _internal_set_sint64_field(value);
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v2.ComplexMessage.sint64_field)
}
...
inline ::uint32_t ComplexMessage::fixed32_field() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v2.ComplexMessage.fixed32_field)
...
inline void ComplexMessage::set_fixed32_field(::uint32_t value) {
  ...
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v2.ComplexMessage.fixed32_field)
}
...
inline ::uint64_t ComplexMessage::fixed64_field() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v2.ComplexMessage.fixed64_field)
...
inline void ComplexMessage::set_fixed64_field(::uint64_t value) {
  ...
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v2.ComplexMessage.fixed64_field)
}
...
inline ::int32_t ComplexMessage::sfixed32_field() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v2.ComplexMessage.sfixed32_field)
...
inline void ComplexMessage::set_sfixed32_field(::int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v2.ComplexMessage.sfixed32_field)
}
...
inline ::int64_t ComplexMessage::sfixed64_field() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v2.ComplexMessage.sfixed64_field)
...
inline void ComplexMessage::set_sfixed64_field(::int64_t value) {
  ...
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v2.ComplexMessage.sfixed64_field)
}
...
inline float ComplexMessage::float_field() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v2.ComplexMessage.float_field)
  return _internal_float_field();
}
inline void ComplexMessage::set_float_field(float value) {
  _internal_set_float_field(value);
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v2.ComplexMessage.float_field)
}
...
inline double ComplexMessage::double_field() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v2.ComplexMessage.double_field)
  return _internal_double_field();
}
inline void ComplexMessage::set_double_field(double value) {
  _internal_set_double_field(value);
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v2.ComplexMessage.double_field)
}
...
inline bool ComplexMessage::bool_field() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v2.ComplexMessage.bool_field)
  return _internal_bool_field();
}
inline void ComplexMessage::set_bool_field(bool value) {
  _internal_set_bool_field(value);
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v2.ComplexMessage.bool_field)
}
...
inline const std::string& ComplexMessage::string_field() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v2.ComplexMessage.string_field)
...
inline PROTOBUF_ALWAYS_INLINE void ComplexMessage::set_string_field(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v2.ComplexMessage.string_field)
}
inline std::string* ComplexMessage::mutable_string_field() {
  std::string* _s = _internal_mutable_string_field();
  // @@protoc_insertion_point(field_mutable:cavnue.messages.data_warehouse.management.v2.ComplexMessage.string_field)
  return _s;
}
...
inline std::string* ComplexMessage::release_string_field() {
  // @@protoc_insertion_point(field_release:cavnue.messages.data_warehouse.management.v2.ComplexMessage.string_field)
...
inline void ComplexMessage::set_allocated_string_field(std::string* value) {
  ...
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:cavnue.messages.data_warehouse.management.v2.ComplexMessage.string_field)
}
...
inline const std::string& ComplexMessage::bytes_field() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v2.ComplexMessage.bytes_field)
...
inline PROTOBUF_ALWAYS_INLINE void ComplexMessage::set_bytes_field(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v2.ComplexMessage.bytes_field)
}
inline std::string* ComplexMessage::mutable_bytes_field() {
  std::string* _s = _internal_mutable_bytes_field();
  // @@protoc_insertion_point(field_mutable:cavnue.messages.data_warehouse.management.v2.ComplexMessage.bytes_field)
  return _s;
}
...
inline std::string* ComplexMessage::release_bytes_field() {
  // @@protoc_insertion_point(field_release:cavnue.messages.data_warehouse.management.v2.ComplexMessage.bytes_field)
...
inline void ComplexMessage::set_allocated_bytes_field(std::string* value) {
  ...
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:cavnue.messages.data_warehouse.management.v2.ComplexMessage.bytes_field)
}
...
inline ::cavnue::messages::data_warehouse::management::v2::ExampleEnum ComplexMessage::enum_field() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v2.ComplexMessage.enum_field)
  return _internal_enum_field();
}
inline void ComplexMessage::set_enum_field(::cavnue::messages::data_warehouse::management::v2::ExampleEnum value) {
   _internal_set_enum_field(value);
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v2.ComplexMessage.enum_field)
}
inline ::cavnue::messages::data_warehouse::management::v2::ExampleEnum ComplexMessage::_internal_enum_field() const {
  return static_cast<::cavnue::messages::data_warehouse::management::v2::ExampleEnum>(_impl_.enum_field_);
}
inline void ComplexMessage::_internal_set_enum_field(::cavnue::messages::data_warehouse::management::v2::ExampleEnum value) {
  ;
...
inline ::int32_t ComplexMessage::repeated_int_field(int index) const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v2.ComplexMessage.repeated_int_field)
...
inline void ComplexMessage::set_repeated_int_field(int index, ::int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v2.ComplexMessage.repeated_int_field)
}
inline void ComplexMessage::add_repeated_int_field(::int32_t value) {
  _internal_add_repeated_int_field(value);
  // @@protoc_insertion_point(field_add:cavnue.messages.data_warehouse.management.v2.ComplexMessage.repeated_int_field)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField<::int32_t>& ComplexMessage::repeated_int_field() const {
  // @@protoc_insertion_point(field_list:cavnue.messages.data_warehouse.management.v2.ComplexMessage.repeated_int_field)
...
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField<::int32_t>* ComplexMessage::mutable_repeated_int_field() {
  // @@protoc_insertion_point(field_mutable_list:cavnue.messages.data_warehouse.management.v2.ComplexMessage.repeated_int_field)
...
inline const ::PROTOBUF_NAMESPACE_ID::Map< std::string, ::cavnue::messages::data_warehouse::management::v2::NestedMessage >&
ComplexMessage::_internal_map_field() const {
  return _impl_.map_field_.GetMap();
}
inline const ::PROTOBUF_NAMESPACE_ID::Map< std::string, ::cavnue::messages::data_warehouse::management::v2::NestedMessage >&
ComplexMessage::map_field() const {
  // @@protoc_insertion_point(field_map:cavnue.messages.data_warehouse.management.v2.ComplexMessage.map_field)
  return _internal_map_field();
}
inline ::PROTOBUF_NAMESPACE_ID::Map< std::string, ::cavnue::messages::data_warehouse::management::v2::NestedMessage >*
ComplexMessage::_internal_mutable_map_field() {
  return _impl_.map_field_.MutableMap();
}
inline ::PROTOBUF_NAMESPACE_ID::Map< std::string, ::cavnue::messages::data_warehouse::management::v2::NestedMessage >*
ComplexMessage::mutable_map_field() {
  // @@protoc_insertion_point(field_mutable_map:cavnue.messages.data_warehouse.management.v2.ComplexMessage.map_field)
...
inline const std::string& ComplexMessage::oneof_string() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v2.ComplexMessage.oneof_string)
...
inline PROTOBUF_ALWAYS_INLINE void ComplexMessage::set_oneof_string(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:cavnue.messages.data_warehouse.management.v2.ComplexMessage.oneof_string)
}
inline std::string* ComplexMessage::mutable_oneof_string() {
  std::string* _s = _internal_mutable_oneof_string();
  // @@protoc_insertion_point(field_mutable:cavnue.messages.data_warehouse.management.v2.ComplexMessage.oneof_string)
  return _s;
}
...
inline std::string* ComplexMessage::release_oneof_string() {
  // @@protoc_insertion_point(field_release:cavnue.messages.data_warehouse.management.v2.ComplexMessage.oneof_string)
  if (test_oneof_case() != kOneofString) {
    return nullptr;
  }
  clear_has_test_oneof();
...
inline void ComplexMessage::set_allocated_oneof_string(std::string* value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:cavnue.messages.data_warehouse.management.v2.ComplexMessage.oneof_string)
}
...
inline ::cavnue::messages::data_warehouse::management::v2::NestedMessage* ComplexMessage::release_oneof_nested_message() {
  // @@protoc_insertion_point(field_release:cavnue.messages.data_warehouse.management.v2.ComplexMessage.oneof_nested_message)
  if (test_oneof_case() == kOneofNestedMessage) {
    clear_has_test_oneof();
    ::cavnue::messages::data_warehouse::management::v2::NestedMessage* temp = _impl_.test_oneof_.oneof_nested_message_;
    if (GetArenaForAllocation() != nullptr) {
...
inline const ::cavnue::messages::data_warehouse::management::v2::NestedMessage& ComplexMessage::_internal_oneof_nested_message() const {
  return test_oneof_case() == kOneofNestedMessage
      ? *_impl_.test_oneof_.oneof_nested_message_
      : reinterpret_cast<::cavnue::messages::data_warehouse::management::v2::NestedMessage&>(::cavnue::messages::data_warehouse::management::v2::_NestedMessage_default_instance_);
}
inline const ::cavnue::messages::data_warehouse::management::v2::NestedMessage& ComplexMessage::oneof_nested_message() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v2.ComplexMessage.oneof_nested_message)
  return _internal_oneof_nested_message();
}
inline ::cavnue::messages::data_warehouse::management::v2::NestedMessage* ComplexMessage::unsafe_arena_release_oneof_nested_message() {
  // @@protoc_insertion_point(field_unsafe_arena_release:cavnue.messages.data_warehouse.management.v2.ComplexMessage.oneof_nested_message)
  if (test_oneof_case() == kOneofNestedMessage) {
    clear_has_test_oneof();
    ::cavnue::messages::data_warehouse::management::v2::NestedMessage* temp = _impl_.test_oneof_.oneof_nested_message_;
    _impl_.test_oneof_.oneof_nested_message_ = nullptr;
...
inline void ComplexMessage::unsafe_arena_set_allocated_oneof_nested_message(::cavnue::messages::data_warehouse::management::v2::NestedMessage* oneof_nested_message) {
  clear_test_oneof();
  if (oneof_nested_message) {
    set_has_oneof_nested_message();
    _impl_.test_oneof_.oneof_nested_message_ = oneof_nested_message;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:cavnue.messages.data_warehouse.management.v2.ComplexMessage.oneof_nested_message)
}
inline ::cavnue::messages::data_warehouse::management::v2::NestedMessage* ComplexMessage::_internal_mutable_oneof_nested_message() {
  if (test_oneof_case() != kOneofNestedMessage) {
    clear_test_oneof();
    set_has_oneof_nested_message();
    _impl_.test_oneof_.oneof_nested_message_ = CreateMaybeMessage< ::cavnue::messages::data_warehouse::management::v2::NestedMessage >(GetArenaForAllocation());
  }
  return _impl_.test_oneof_.oneof_nested_message_;
}
inline ::cavnue::messages::data_warehouse::management::v2::NestedMessage* ComplexMessage::mutable_oneof_nested_message() {
  ::cavnue::messages::data_warehouse::management::v2::NestedMessage* _msg = _internal_mutable_oneof_nested_message();
  // @@protoc_insertion_point(field_mutable:cavnue.messages.data_warehouse.management.v2.ComplexMessage.oneof_nested_message)
  return _msg;
}
...
inline const ::cavnue::messages::data_warehouse::management::v2::NestedMessage& ComplexMessage::_internal_nested_message_field() const {
  const ::cavnue::messages::data_warehouse::management::v2::NestedMessage* p = _impl_.nested_message_field_;
  return p != nullptr ? *p : reinterpret_cast<const ::cavnue::messages::data_warehouse::management::v2::NestedMessage&>(
      ::cavnue::messages::data_warehouse::management::v2::_NestedMessage_default_instance_);
}
inline const ::cavnue::messages::data_warehouse::management::v2::NestedMessage& ComplexMessage::nested_message_field() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v2.ComplexMessage.nested_message_field)
...
inline void ComplexMessage::unsafe_arena_set_allocated_nested_message_field(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:cavnue.messages.data_warehouse.management.v2.ComplexMessage.nested_message_field)
}
inline ::cavnue::messages::data_warehouse::management::v2::NestedMessage* ComplexMessage::release_nested_message_field() {
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::cavnue::messages::data_warehouse::management::v2::NestedMessage* temp = _impl_.nested_message_field_;
...
inline ::cavnue::messages::data_warehouse::management::v2::NestedMessage* ComplexMessage::unsafe_arena_release_nested_message_field() {
  // @@protoc_insertion_point(field_release:cavnue.messages.data_warehouse.management.v2.ComplexMessage.nested_message_field)
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::cavnue::messages::data_warehouse::management::v2::NestedMessage* temp = _impl_.nested_message_field_;
  _impl_.nested_message_field_ = nullptr;
  return temp;
}
inline ::cavnue::messages::data_warehouse::management::v2::NestedMessage* ComplexMessage::_internal_mutable_nested_message_field() {
  _impl_._has_bits_[0] |= 0x00000001u;
  if (_impl_.nested_message_field_ == nullptr) {
    auto* p = CreateMaybeMessage<::cavnue::messages::data_warehouse::management::v2::NestedMessage>(GetArenaForAllocation());
    _impl_.nested_message_field_ = p;
  }
  return _impl_.nested_message_field_;
}
inline ::cavnue::messages::data_warehouse::management::v2::NestedMessage* ComplexMessage::mutable_nested_message_field() {
  ::cavnue::messages::data_warehouse::management::v2::NestedMessage* _msg = _internal_mutable_nested_message_field();
  // @@protoc_insertion_point(field_mutable:cavnue.messages.data_warehouse.management.v2.ComplexMessage.nested_message_field)
  return _msg;
}
inline void ComplexMessage::set_allocated_nested_message_field(::cavnue::messages::data_warehouse::management::v2::NestedMessage* nested_message_field) {
  ...
  _impl_.nested_message_field_ = nested_message_field;
  // @@protoc_insertion_point(field_set_allocated:cavnue.messages.data_warehouse.management.v2.ComplexMessage.nested_message_field)
}
...
inline const ::PROTOBUF_NAMESPACE_ID::Timestamp& ComplexMessage::timestamp_field() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v2.ComplexMessage.timestamp_field)
...
inline void ComplexMessage::unsafe_arena_set_allocated_timestamp_field(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:cavnue.messages.data_warehouse.management.v2.ComplexMessage.timestamp_field)
}
...
inline ::PROTOBUF_NAMESPACE_ID::Timestamp* ComplexMessage::unsafe_arena_release_timestamp_field() {
  // @@protoc_insertion_point(field_release:cavnue.messages.data_warehouse.management.v2.ComplexMessage.timestamp_field)
  _impl_._has_bits_[0] &= ~0x00000002u;
  ::PROTOBUF_NAMESPACE_ID::Timestamp* temp = _impl_.timestamp_field_;
  _impl_.timestamp_field_ = nullptr;
  return temp;
...
inline ::PROTOBUF_NAMESPACE_ID::Timestamp* ComplexMessage::mutable_timestamp_field() {
  ...
  // @@protoc_insertion_point(field_mutable:cavnue.messages.data_warehouse.management.v2.ComplexMessage.timestamp_field)
  return _msg;
}
inline void ComplexMessage::set_allocated_timestamp_field(::PROTOBUF_NAMESPACE_ID::Timestamp* timestamp_field) {
  ...
  _impl_.timestamp_field_ = timestamp_field;
  // @@protoc_insertion_point(field_set_allocated:cavnue.messages.data_warehouse.management.v2.ComplexMessage.timestamp_field)
}
...
inline const ::PROTOBUF_NAMESPACE_ID::Duration& ComplexMessage::duration_field() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v2.ComplexMessage.duration_field)
...
inline void ComplexMessage::unsafe_arena_set_allocated_duration_field(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:cavnue.messages.data_warehouse.management.v2.ComplexMessage.duration_field)
}
...
inline ::PROTOBUF_NAMESPACE_ID::Duration* ComplexMessage::unsafe_arena_release_duration_field() {
  // @@protoc_insertion_point(field_release:cavnue.messages.data_warehouse.management.v2.ComplexMessage.duration_field)
  _impl_._has_bits_[0] &= ~0x00000004u;
  ::PROTOBUF_NAMESPACE_ID::Duration* temp = _impl_.duration_field_;
  _impl_.duration_field_ = nullptr;
  return temp;
...
inline ::PROTOBUF_NAMESPACE_ID::Duration* ComplexMessage::mutable_duration_field() {
  ...
  // @@protoc_insertion_point(field_mutable:cavnue.messages.data_warehouse.management.v2.ComplexMessage.duration_field)
  return _msg;
}
inline void ComplexMessage::set_allocated_duration_field(::PROTOBUF_NAMESPACE_ID::Duration* duration_field) {
  ...
  _impl_.duration_field_ = duration_field;
  // @@protoc_insertion_point(field_set_allocated:cavnue.messages.data_warehouse.management.v2.ComplexMessage.duration_field)
}
...
inline const ::cavnue::messages::data_warehouse::management::v2::CustomMetadata& ComplexMessage::_internal_custom_metadata() const {
  const ::cavnue::messages::data_warehouse::management::v2::CustomMetadata* p = _impl_.custom_metadata_;
  return p != nullptr ? *p : reinterpret_cast<const ::cavnue::messages::data_warehouse::management::v2::CustomMetadata&>(
      ::cavnue::messages::data_warehouse::management::v2::_CustomMetadata_default_instance_);
}
inline const ::cavnue::messages::data_warehouse::management::v2::CustomMetadata& ComplexMessage::custom_metadata() const {
  // @@protoc_insertion_point(field_get:cavnue.messages.data_warehouse.management.v2.ComplexMessage.custom_metadata)
...
inline void ComplexMessage::unsafe_arena_set_allocated_custom_metadata(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:cavnue.messages.data_warehouse.management.v2.ComplexMessage.custom_metadata)
}
inline ::cavnue::messages::data_warehouse::management::v2::CustomMetadata* ComplexMessage::release_custom_metadata() {
  _impl_._has_bits_[0] &= ~0x00000008u;
  ::cavnue::messages::data_warehouse::management::v2::CustomMetadata* temp = _impl_.custom_metadata_;
...
inline ::cavnue::messages::data_warehouse::management::v2::CustomMetadata* ComplexMessage::unsafe_arena_release_custom_metadata() {
  // @@protoc_insertion_point(field_release:cavnue.messages.data_warehouse.management.v2.ComplexMessage.custom_metadata)
  _impl_._has_bits_[0] &= ~0x00000008u;
  ::cavnue::messages::data_warehouse::management::v2::CustomMetadata* temp = _impl_.custom_metadata_;
  _impl_.custom_metadata_ = nullptr;
  return temp;
}
inline ::cavnue::messages::data_warehouse::management::v2::CustomMetadata* ComplexMessage::_internal_mutable_custom_metadata() {
  _impl_._has_bits_[0] |= 0x00000008u;
  if (_impl_.custom_metadata_ == nullptr) {
    auto* p = CreateMaybeMessage<::cavnue::messages::data_warehouse::management::v2::CustomMetadata>(GetArenaForAllocation());
    _impl_.custom_metadata_ = p;
  }
  return _impl_.custom_metadata_;
}
inline ::cavnue::messages::data_warehouse::management::v2::CustomMetadata* ComplexMessage::mutable_custom_metadata() {
  ::cavnue::messages::data_warehouse::management::v2::CustomMetadata* _msg = _internal_mutable_custom_metadata();
  // @@protoc_insertion_point(field_mutable:cavnue.messages.data_warehouse.management.v2.ComplexMessage.custom_metadata)
  return _msg;
}
inline void ComplexMessage::set_allocated_custom_metadata(::cavnue::messages::data_warehouse::management::v2::CustomMetadata* custom_metadata) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
  ...
  _impl_.custom_metadata_ = custom_metadata;
  // @@protoc_insertion_point(field_set_allocated:cavnue.messages.data_warehouse.management.v2.ComplexMessage.custom_metadata)
}
...
template <>
struct is_proto_enum<::cavnue::messages::data_warehouse::management::v2::ExampleEnum> : std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor<::cavnue::messages::data_warehouse::management::v2::ExampleEnum>() {
  return ::cavnue::messages::data_warehouse::management::v2::ExampleEnum_descriptor();
}
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_cavnue_2fmessages_2fdata_5fwarehouse_2fmanagement_2fv2_2fcomplex_5fexample_2eproto_2epb_2eh
